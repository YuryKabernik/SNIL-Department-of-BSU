...
namespace SnilAcademicDepartment.Common.LoggerAdapter
{
    /// <summary>
    /// Implementation that proxies to log4net, to Serilog, Microsoft.Extensions.Logging, NLog or any other logging library.
    /// </summary>
    /// <typeparam name="T">Type of Logger name.</typeparam>
    public class NLogAdapter<T> : ILogger
    {
        /// <summary>
        /// Field of logger setting.
        /// </summary>
        ...
        public event EventHandler<EventArgs> LoggerReconfigured
        {
            add
            {
                _logger.LoggerReconfigured += value;
            }
