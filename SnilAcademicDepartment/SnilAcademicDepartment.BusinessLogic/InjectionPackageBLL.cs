...
using SnilAcademicDepartment.BusinessLogic.Services.API;
...
namespace SnilAcademicDepartment.BusinessLogic
{
	public class InjectionPackageBLL : IPackage
	{
		public void RegisterServices(Container container)
		{
			...
			container.Register<ISpmaParticipants, SpmaParticipants>(Lifestyle.Scoped);
		...
		protected void RegisterApiServices(Container container)
		{
			...
			container.Register<IDiplomasApiService, DiplomasServices>(Lifestyle.Scoped);
		}
	}
}
