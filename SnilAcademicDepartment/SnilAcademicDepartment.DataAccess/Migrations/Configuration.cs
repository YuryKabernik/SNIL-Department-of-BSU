...
namespace SnilAcademicDepartment.DataAccess.Migrations
{
	internal sealed class Configuration : DbMigrationsConfiguration<SnilDBContext>
	{
		...
		private static string _docPath = System.AppDomain.CurrentDomain.BaseDirectory + "img\\Head - BSU.docx"; // D:\Visual Studio Projects\SNIL\SnilAcademicDepartment\SnilAcademicDepartment.DataAccess\img\Ðåêòîðó  - ÁÃÓ.docx
