...
namespace SnilAcademicDepartment.DataAccess.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<SnilDBContext>
    {
        ...
        private static string _docPath = @"D:\GitHub_projects\SNIL\SNIL-Department-of-BSU\SnilAcademicDepartment\SnilAcademicDepartment.DataAccess\img\–ÂÍÚÓÛ  - ¡√”.docx"; // D:\Visual Studio Projects\SNIL\SnilAcademicDepartment\SnilAcademicDepartment.DataAccess\img\–ÂÍÚÓÛ  - ¡√”.docx
        ...
        protected override void Seed(SnilAcademicDepartment.DataAccess.SnilDBContext context)
        {
            using (var db = new SnilDBContext())
            {
                ...
                PreviewDBInit.DBInit(db, "»ÒÚÓËˇ", "RU", this._pageTypes[4], this._languages[0], this._imgByte);
                PreviewDBInit.DBInit(db, "History", "EN", this._pageTypes[4], this._languages[1], this._imgByte);
                PreviewDBInit.DBInit(db, "»ÒÚÓËˇDE", "DE", this._pageTypes[4], this._languages[2], this._imgByte);

                // Init People page preview data.
                PreviewDBInit.DBInit(db, "œÂÒÓÌ‡Î", "RU", this._pageTypes[3], this._languages[0], this._imgByte);
                PreviewDBInit.DBInit(db, "People", "EN", this._pageTypes[3], this._languages[1], this._imgByte);
                PreviewDBInit.DBInit(db, "œÂÒÓÌ‡ÎDE", "DE", this._pageTypes[3], this._languages[2], this._imgByte);

                // Init Projects page preview data.
                PreviewDBInit.DBInit(db, "œÓÂÍÚ˚", "RU", this._pageTypes[1], this._languages[0], this._imgByte);
                PreviewDBInit.DBInit(db, "Projects", "EN", this._pageTypes[1], this._languages[1], this._imgByte);
                PreviewDBInit.DBInit(db, "œÓÂÍÚ˚DE", "DE", this._pageTypes[1], this._languages[2], this._imgByte);

                // Init Education page preview data.
                PreviewDBInit.DBInit(db, "Œ·Û˜ÂÌËÂ", "RU", this._pageTypes[0], this._languages[0], this._imgByte);
                PreviewDBInit.DBInit(db, "Education", "EN", this._pageTypes[0], this._languages[1], this._imgByte);
                PreviewDBInit.DBInit(db, "Œ·Û˜ÂÌËÂDE", "DE", this._pageTypes[0], this._languages[2], this._imgByte);

                // Init Home page preview data.
                PreviewDBInit.DBInit(db, "ƒÓÏProjects", "RUProjects", this._pageTypes[2], this._languages[0], this._imgByte, true);
                PreviewDBInit.DBInit(db, "HomeProjects", "ENProjects", this._pageTypes[2], this._languages[1], this._imgByte, true);
                PreviewDBInit.DBInit(db, "ƒÓÏDEProjects", "DEProjects", this._pageTypes[2], this._languages[2], this._imgByte, true);

                PreviewDBInit.DBInit(db, "ƒÓÏEducation", "RUEducation", this._pageTypes[2], this._languages[0], this._imgByte, true);
                PreviewDBInit.DBInit(db, "HomeEducation", "ENEducation", this._pageTypes[2], this._languages[1], this._imgByte, true);
                PreviewDBInit.DBInit(db, "ƒÓÏDEEducation", "DEEducation", this._pageTypes[2], this._languages[2], this._imgByte, true);

                PreviewDBInit.DBInit(db, "ƒÓÏPeople", "RUPeople", this._pageTypes[2], this._languages[0], this._imgByte, true);
                PreviewDBInit.DBInit(db, "HomePeople", "ENPeople", this._pageTypes[2], this._languages[1], this._imgByte, true);
                PreviewDBInit.DBInit(db, "ƒÓÏDEPeople", "DEPeople", this._pageTypes[2], this._languages[2], this._imgByte, true);

                PreviewDBInit.DBInit(db, "ƒÓÏHistory", "RUHistory", this._pageTypes[2], this._languages[0], this._imgByte, true);
                PreviewDBInit.DBInit(db, "HomeHistory", "ENHistory", this._pageTypes[2], this._languages[1], this._imgByte, true);
                PreviewDBInit.DBInit(db, "ƒÓÏDEHistory", "DEHistory", this._pageTypes[2], this._languages[2], this._imgByte, true);
