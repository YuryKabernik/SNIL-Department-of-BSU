...
namespace SnilAcademicDepartment.Controllers
{
	...
	/// </summary>
	/// <seealso cref="SnilAcademicDepartment.Base.SnilBaseController" />
	public class CookiesController : SnilBaseController
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CookiesController"/> class.
		/// </summary>
		...
		public async Task<ActionResult> ChangeCulture(string lang)
		{
			...
			try
			{
				HttpCookie requestCookie = this.Request.Cookies["language"];
			...
			{
				string errMessage = $"Change culture error occured in {ex.TargetSite} by stack trace {ex.StackTrace}." +
		...
		{
			string returnUrl;
			string[] segm = Request.UrlReferrer.Segments;
